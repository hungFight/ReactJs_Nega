export const register = {
    vi: {
        ...
        messagePassword: 'Mật khẩu nhập lại không đúng hoặc mật khẩu phải 6 ký tự trở lên.',
    ...
    en: {
        ...
        messagePassword: 'The password is incorrect, please try again or must be greater than 6 characters.',
